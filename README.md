...
# Read dataset
data = pd.read_csv(r"C:\Users\acer\Downloads\customers_large_dataset.csv")

# Display columns and first 5 records
...
## OUTPUT:
<img width="828" height="732" alt="image" src="https://github.com/user-attachments/assets/481a44af-94c4-40b2-b875-37ae716b0aa2" />
